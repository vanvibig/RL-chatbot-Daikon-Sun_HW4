...
def params_setup(cmdline=None):
  ...
  parser.add_argument('--vocab_size', type=int, default=1078, help='Dialog vocabulary size.')
  ...
  parser.add_argument('--steps_per_checkpoint', type=int, default=2, help='How many training steps to do per checkpoint')
